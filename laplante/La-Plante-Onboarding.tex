...
\includepdf[pages=1]{images/cover-old.pdf}
\cleardoublepage
...
\hypertarget{mauricio-la-plante}{%
\section{Mauricio La Plante}\label{mauricio-la-plante}}

\hypertarget{industrial-development-reporter}{%
\subsection{Industrial \& Development Reporter}\label{industrial-development-reporter}}

\textbf{Thursday, Dec.~14, 2023}
...
\addcontentsline{toc}{chapter}{Thoughts on Journalism}
...
\addcontentsline{toc}{chapter}{More Thoughts on Journalism}
...
Other media in the area that I keep an eye on include WJCT News --- which has really been leaning into news coverage recently --- as well as The Jaxon, The Coastal, Edible Northeast Florida, Jacksonville Magazine and Folio Weekly.
